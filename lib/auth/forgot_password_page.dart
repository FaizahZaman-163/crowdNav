  ...
  String _friendlyAuthError(AuthException e) {
    switch (e.code) {
      case 'over_email_send_rate_limit':
        return 'Too many reset emails sent. Please wait at least 1 hour before trying again.';
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Supabase free tier allows 2 reset emails per hour. If the button is disabled, please wait before retrying.',
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              Expanded(
                child: Text(
                  'The link expires in 1 hour. If you need another, wait 1 hour before resending.',
                  style: TextStyle(fontSize: 11, color: Colors.orange.shade800, height: 1.4),
                ),
              ),
            ],
